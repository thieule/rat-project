...
/**
 * TFilterInput is a class for filtering input from any data source
 *
 ...
 * @since       5/2014
 */
class TFilterInput extends TObject
{
	/**
	 * @var    array  A container for TFilterInput instances.
	 * @since  11.3
	 */
	 ...
	 * @param   integer  $xssAuto     Only auto clean essentials = 0, Allow clean blacklisted tags/attr = 1
	 *
	 * @return  TFilterInput  The TFilterInput object.
	 *
	 * @since   5/2014
	 */
	public static function &getInstance($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1)
	{
		...
		{
			self::$instances[$sig] = new TFilterInput($tagsArray, $attrArray, $tagsMethod, $attrMethod, $xssAuto);
		}
