 ...
 * @since       5/2014
 */
class TBrowser extends TObject
{
	...
	/**
	 * @var    array  TBrowser instances container.
	 * @since  5/2014
	 */
	 ...
	 * @param   string  $accept     The HTTP_ACCEPT settings to use.
	 *
	 * @return TBrowser  The Browser object.
	 *
	 * @since  5/2014
	 */
	static public function getInstance($userAgent = null, $accept = null)
	{
		...
		{
			self::$instances[$signature] = new TBrowser($userAgent, $accept);
		}
	...
	protected function identifyBrowserVersion()
	{
		...
		$this->_minorVersion = 0;
		TLog::add("Can't identify browser version. Agent: " . $this->_agent, TLog::NOTICE);
	}
	...
	/**
	 * Internal copy of TBrowser::setQuirk() to prevent deprecation warning.
	 *
	 * @param   string  $quirk  The behavior to set.
	 * @param   string  $value  Special behavior parameter.
	 *
	...
	{
		TLog::add('TBrowser::setQuirk() is deprecated.', TLog::WARNING, 'deprecated');
		$this->_quirks[$quirk] = $value;
	}
	...
	{
		TLog::add('TBrowser::hasQuirk() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		TLog::add('TBrowser::getQuirk() is deprecated.', TLog::WARNING, 'deprecated');
		return isset($this->_quirks[$quirk]) ? $this->_quirks[$quirk] : null;
	}

	/**
	 * Internal copy of TBrowser::setFeature() to prevent deprecation warning.
	 *
	...
	{
		TLog::add('TBrowser::setFeature() is deprecated.', TLog::WARNING, 'deprecated');
		$this->_features[$feature] = $value;
	}
	...
	{
		TLog::add('TBrowser::hasFeature() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		TLog::add('TBrowser::getFeature() is deprecated.', TLog::WARNING, 'deprecated');
