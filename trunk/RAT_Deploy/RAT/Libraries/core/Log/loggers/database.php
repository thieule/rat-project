 ...
 * @since       5/2014
 */
class JLoggerDatabase extends TLogger
{
	/**
	...
	public function __construct(array &$options)
	{
		...
		else
		{
			...
			$this->prefix = (empty($this->options['db_prefix'])) ? 't_' : $this->options['db_prefix'];
		}
	...
	protected function connect()
	{
		...
		try
		{
			...
			if ($db->getErrorNum() > 0)
			{
				throw new LogException(Text::_('LIB_UTIL_ERROR_CONNECT_DATABASE'));
			}
