 ...
 * @since       5/2014
 */
abstract class TDatabaseQuery
{
	/**
	 * @var    TDatabase  The database connection resource.
	 * @since  5/2014
	 */
	protected $db = null;
	...
	/**
	 * @var    TDatabaseQueryElement  The query element for a generic query (type = null).
	 * @since  5/2014
	 */
	protected $element = null;

	/**
	 * @var    TDatabaseQueryElement  The select element.
	 * @since  5/2014
	 */
	protected $select = null;

	/**
	 * @var    TDatabaseQueryElement  The delete element.
	 * @since  5/2014
	 */
	protected $delete = null;

	/**
	 * @var    TDatabaseQueryElement  The update element.
	 * @since  5/2014
	 */
	protected $update = null;

	/**
	 * @var    TDatabaseQueryElement  The insert element.
	 * @since  5/2014
	 */
	protected $insert = null;

	/**
	 * @var    TDatabaseQueryElement  The from element.
	 * @since  5/2014
	 */
	protected $from = null;

	/**
	 * @var    TDatabaseQueryElement  The join element.
	 * @since  5/2014
	 */
	protected $join = null;

	/**
	 * @var    TDatabaseQueryElement  The set element.
	 * @since  5/2014
	 */
	protected $set = null;

	/**
	 * @var    TDatabaseQueryElement  The where element.
	 * @since  5/2014
	 */
	protected $where = null;

	/**
	 * @var    TDatabaseQueryElement  The group by element.
	 * @since  5/2014
	 */
	protected $group = null;

	/**
	 * @var    TDatabaseQueryElement  The having element.
	 * @since  5/2014
	 */
	protected $having = null;

	/**
	 * @var    TDatabaseQueryElement  The column list for an INSERT statement.
	 * @since  5/2014
	 */
	protected $columns = null;

	/**
	 * @var    TDatabaseQueryElement  The values list for an INSERT statement.
	 * @since  5/2014
	 */
	protected $values = null;

	/**
	 * @var    TDatabaseQueryElement  The order element.
	 * @since  5/2014
	 */
	protected $order = null;

	/**
	 * @var    TDatabaseQueryElement  The union element.
	 * @since  12.1
	 */
	 ...
	 * Class constructor.
	 *
	 * @param   TDatabase  $db  The database connector resource.
	 *
	 * @since   5/2014
	 */
	public function __construct(TDatabase $db = null)
	{
		$this->db = $db;
	}
	 ...
	 *
	 * @return  TDatabaseQuery  Returns this object to allow chaining.
	 *
	 * @since   5/2014
	 */
	...
	public function columns($columns)
	{
		...
		{
			$this->columns = new TDatabaseQueryElement('()', $columns);
		}
		else
		{
	...
	{
		if (!($this->db instanceof TDatabase))
		{
			throw new TDatabaseException('JLIB_DATABASE_ERROR_INVALID_DB_OBJECT');
		}
	...
	{
		$this->type = 'delete';
		$this->delete = new TDatabaseQueryElement('DELETE', null);
	 ...
	 *
	 * Note that 'e' is an alias for this method as it is in TDatabase.
	 *
	...
	public function from($tables)
	{
		...
		{
			$this->from = new TDatabaseQueryElement('FROM', $tables);
		}
		else
		{
	...
	public function group($columns)
	{
		...
		{
			$this->group = new TDatabaseQueryElement('GROUP BY', $columns);
		}
		else
		{
	...
	public function having($conditions, $glue = 'AND')
	{
		if (is_null($this->having))
		{
			...
			$this->having = new TDatabaseQueryElement('HAVING', $conditions, " $glue ");
		}
		else
		{
	...
	{
		$this->type = 'insert';
		$this->insert = new TDatabaseQueryElement('INSERT INTO', $table);
	...
	public function join($type, $conditions)
	{
		...
		$this->join[] = new TDatabaseQueryElement(strtoupper($type) . ' JOIN', $conditions);
	...
	public function order($columns)
	{
		...
		{
			$this->order = new TDatabaseQueryElement('ORDER BY', $columns);
		}
		else
		{
	 ...
	 *
	 * Note that 'q' is an alias for this method as it is in TDatabase.
	 *
	 * Usage:
	 ...
	 *
	 * Note that 'qn' is an alias for this method as it is in TDatabase.
	 *
	 * Usage:
	 * $query->quoteName('#__a');
	 * $query->qn('#__a');
	...
	public function select($columns)
	{
		...
		{
			$this->select = new TDatabaseQueryElement('SELECT', $columns);
		}
		else
		{
	...
	public function set($conditions, $glue = ',')
	{
		...
		{
			$glue = strtoupper($glue);
			$this->set = new TDatabaseQueryElement('SET', $conditions, "\n\t$glue ");
		}
		else
		{
	...
	{
		$this->type = 'update';
		$this->update = new TDatabaseQueryElement('UPDATE', $table);
	...
	public function values($values)
	{
		...
		{
			$this->values = new TDatabaseQueryElement('()', $values, '),(');
		}
		else
		{
	...
	public function where($conditions, $glue = 'AND')
	{
		...
		{
			$glue = strtoupper($glue);
			$this->where = new TDatabaseQueryElement('WHERE', $conditions, " $glue ");
		}
		else
		{
   ...
   /**
	 ...
	 *
	 * @param   mixed    $query     The TDatabaseQuery object or string to union.
	 * @param   boolean  $distinct  True to only return distinct rows from the union.
	 * @param   string   $glue      The glue by which to join the conditions.
	 *
	 * @return  mixed    The TDatabaseQuery object on success or boolean false on failure.
	 *
	 * @since   12.1
	 */
	public function union($query, $distinct = false, $glue = '')
	{
		...
		// Get the TDatabaseQueryElement if it does not exist
		if (is_null($this->union))
		{
				$this->union = new TDatabaseQueryElement($name, $query, "$glue");
		}
