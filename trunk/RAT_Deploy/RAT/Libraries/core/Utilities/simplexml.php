 ...
 *
 * The XML Parser extension (expat) is required to use TSimpleXML.
 *
 ...
 * 		TSimpleXML, not implicit as with PHP5. Write
 ...
 * </code>
 *
 * Note: TSimpleXML cannot be used to access sophisticated XML doctypes
 ...
 * @since       5/2014
 */
class TSimpleXML extends TObject
{
	/**
	 * The XML parser
	 *
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::__construct() is deprecated.', TLog::WARNING, 'deprecated');
	 ...
	 * TSimpleXMLElement with properties containing the data held within the XML document.
	 ...
	 *
	 * @return  object  TSimpleXMLElement
	 *
	 * @since   5/2014
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::loadString() is deprecated.', TLog::WARNING, 'deprecated');
	 ...
	 * to an object  of class TSimpleXMLElement. If any errors occur during file access or
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::loadfile() is deprecated.', TLog::WARNING, 'deprecated');
	...
	/**
	 * Get a TSimpleXMLElement object from a DOM node.
	 *
	 * This function takes a node of a DOM  document and makes it into a TSimpleXML node.
	 * This new object can then be used as a native TSimpleXML element. If any errors occur,
	 * it returns FALSE.
	 *
	 * @param   string  $node       DOM  document
	 * @param   string  $classname  currently ignored
	 *
	 * @return  mixed  TSimpleXMLElement or false if any errors occur
	 *
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::importDOM() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::getParser() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::setParser() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::_parse() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::_handleError() is deprecated.', TLog::WARNING, 'deprecated');

		TError::raiseWarning('SOME_ERROR_CODE', 'XML Parsing Error at ' . $line . ':' . $col . '. Error ' . $code . ': ' . xml_error_string($code));
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::_getStackLocation() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::startElement() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::endElement() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXML::_characterData() is deprecated.', TLog::WARNING, 'deprecated');
 ...
 * @since       5/2014
 */
class TSimpleXMLElement extends TObject
{
	/**
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::__construct() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::name() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::attributes() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::data() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::children() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::level() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::addAttribute() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::removeAttribute() is deprecated.', TLog::WARNING, 'deprecated');
	 ...
	 *
	 * @return  TSimpleXMLElement  The added child object
	 *
	 * @since   5/2014
	 */
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::addChild() is deprecated.', TLog::WARNING, 'deprecated');
	 ...
	 *
	 * @param   TSimpleXmlElement  &$child  The child element to remove.
	 *
	 * @return  void
	 *
	 * @since   5/2014
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::removeChild() is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::getElementByPath() is deprecated.', TLog::WARNING, 'deprecated');
	...
	/**
	 * Traverses the tree calling the $callback(TSimpleXMLElement
	 * $this, mixed $args=array()) function with each TSimpleXMLElement.
	 *
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::map) is deprecated.', TLog::WARNING, 'deprecated');
	...
	{
		// Deprecation warning.
		TLog::add('TSimpleXMLElement::toString() is deprecated.', TLog::WARNING, 'deprecated');
