 ...
 * @since       5/2014
 */
class TDispatcher extends JObject
{
	/**
	 ...
	 *
	 * @return  TDispatcher  The EventDispatcher object.
	 *
	 * @since   5/2014
	 */
	...
	/**
	 * Get the state of the TDispatcher object
	 *
	...
	public function register($event, $handler)
	{
		...
		{
			return TError::raiseWarning('SOME_ERROR_CODE', Text::sprintf('JLIB_EVENT_ERROR_DISPATCHER', $handler));
		}
	}
