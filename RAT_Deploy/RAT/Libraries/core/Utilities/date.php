...
/**
 * TDate is a class that stores a date and provides logic to manipulate
...
class TDate extends DateTime
{
	...
	public function __construct($date = 'now', $tz = null)
	{
		...
		// reset the timezone for 3rd party libraries/extension that does not use TDate
	...
	{
		// Deprecation warning.
		JLog::add('TDate::setOffset() is deprecated.', JLog::WARNING, 'deprecated');
	 ...
	 * @return  string   The date as a formatted string.
	 *
	 * @deprecated  Use TDate::format() instead.
	 *
	 * @deprecated  12.1 Use TDate::format() instead.
	 */
	public function toFormat($format = '%Y-%m-%d %H:%M:%S', $local = false)
	{
		// Deprecation warning.
		JLog::add('TDate::toFormat() is deprecated.', JLog::WARNING, 'deprecated');
	 ...
	 * @since   5/2014
	 * @deprecated 12.1 Use TDate::toSql()
	 */
	public function toMySQL($local = false)
	{
		JLog::add('TDate::toMySQL() is deprecated. Use TDate::toSql() instead.', JLog::WARNING, 'deprecated');
	 ...
	 *
	 * @param   boolean    $local  True to return the date string in the local time zone, false to return it in GMT.
	 * @param   JDatabase  $dbo    The database driver or null to use T::getDbo()
	 *
