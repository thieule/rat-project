 ...
 * @since       5/2014
 */
abstract class TSessionStorage extends TObject
{
	/**
	 * @var    array  TSessionStorage instances container.
	 * @since  11.3
	 */
	 ...
	 *
	 * @return  TSessionStorage
	 *
	 * @since   5/2014
	 */
	public static function getInstance($name = 'none', $options = array())
	{
		$name = strtolower(TFilterInput::getInstance()->clean($name, 'word'));
		...
		if (empty(self::$instances[$name]))
		{
			...
			if (!class_exists($class))
			{
				...
				else
				{
					...
					texit('Unable to load session storage class: ' . $name);
				}
			}
