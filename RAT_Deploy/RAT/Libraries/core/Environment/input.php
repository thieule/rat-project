...
TLoader::discover('TInput', dirname(__FILE__) . '/input');
...
{
	/**
	 * Options array for the TInput instance.
	 *
	 * @var    array
	 * @since  5/2014
	 */
	 ...
	 *
	 * @return  TInput  The request input object
	 *
	 * @since   5/2014
	 */
	public function __get($name)
	{
		...
		{
			$this->inputs[$name] = new TInput($GLOBALS[$superGlobal], $this->options);
			return $this->inputs[$name];
		}
