 ...
 * for the T Platform to access and manipulate a URI.  Second it obtains the URI of
...
class TURI extends TObject
{
	...
	/**
	 * @var    array  An array of TURI instances.
	 * @since  5/2014
	 */
	...
	/**
	 * Returns the global TURI object, only creating it
	 * if it doesn't already exist.
	 *
	 * @param   string  $uri  The URI to parse.  [optional: if null uses script URI]
	 *
	 * @return  TURI  The URI object.
	 *
	 * @since   5/2014
	 */
	public static function getInstance($uri = 'SERVER')
	{
		...
		if (empty(self::$instances[$uri]))
		{
			...
			// Create the new TURI instance
			self::$instances[$uri] = new TURI($theURI);
		}
	...
	public function parse($uri)
	{
		...
		if ($_parts = TString::parse_url($uri))
		{
			$retval = true;
		}
