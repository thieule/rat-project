...
ratApp.controller("employerController",function($scope,$http,$location,userSvc) {
    $scope.mode = "custom";
    $scope.maxHeight = 0;
    ...
    $scope.initData  = function () {
        ...
        $scope.addSamples = function () {
            $scope.loadData([
                ...
                {"id": "2f85dbeb-0845-404e-934e-218bf39750c0", "description": "Thieu Le", "order": 0, "tasks": [
                    // Dates can be specified as string, timestamp or javascript date object. The data attribute can be used to attach a custom object
                    {"id": "f55549b5-e449-4b0c-9f4b-8b33381f7d76", "subject": "Thieu Le", "color": "#93C47D", "from": "2013-10-07T09:00:00", "to": "2013-10-07T10:00:00", "data": "Can contain any custom data or object"},
                ...
                {"id": "b8d10927-cf50-48bd-a056-3554decab824", "description": "Phu Ha", "order": 1, "tasks": [
                ...
                {"id": "c65c2672-445d-4297-a7f2-30de241b3145", "description": "Tan Duy", "order": 2, "tasks": [
